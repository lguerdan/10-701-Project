...
def train(
    ...
    for epoch in range(n_epochs):
        ...
        writer.add_scalar(tag='Train accuaracy', scalar_value=train_acc, global_step=epoch)

        # Write testing metrics
        writer.add_scalar(tag='Test loss', scalar_value=test_loss, global_step=epoch)
        writer.add_scalar(tag='Test accuaracy', scalar_value=test_acc, global_step=epoch)
